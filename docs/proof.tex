...
\fcolorbox{red}{white}{%
    \begin{minipage}{\dimexpr\linewidth-2\fboxsep-2\fboxrule}
        \centering
        \textbf{\huge WARNING: This document is OUTDATED.}\\
        \vspace{0.5em}
        The latest and authoritative source of the proof is the Lean 4 code in this repository.\\
        The documentation in this PDF will be updated later to reflect the current state of the formalization.\\
        Please refer to \texttt{README.md} and the \texttt{.lean} files for accurate information.
    \end{minipage}%
}
\vspace{1em}
