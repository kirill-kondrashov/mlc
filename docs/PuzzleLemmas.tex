...
For parameters in the Mandelbrot set, the critical point 0 is always contained in its puzzle piece (which is defined *around* 0, but this confirms the set is non-empty and well-defined).
