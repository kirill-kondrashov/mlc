...
\noindent
Proof explanation of the modulus summable theorem:
...
For the base case $N=0$ this is trivial. For the inductive step use the decomposition

\[
P_0\setminus P_{k+1}=(P_0\setminus P_k)\cup(P_k\setminus P_{k+1}),
\]

observe the union is disjoint, and apply Grötzsch's inequality to obtain
